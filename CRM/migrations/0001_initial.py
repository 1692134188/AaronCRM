    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('branch', models.ForeignKey(on_delete=None, to='CRM.Branch')),
            ],
        ),
        migrations.CreateModel(
            name='Course',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('class_grade', models.ForeignKey(on_delete=None, to='CRM.ClassList', verbose_name='上课班级')),
            ],
        ),
        migrations.CreateModel(
            name='CustomerInfo',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateTimeField(auto_now_add=True)),
                ('course_record', models.ForeignKey(on_delete=None, to='CRM.CourseRecord')),
                ('student', models.ForeignKey(on_delete=None, to='CRM.Student')),
            ],
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='consultant',
            field=models.ForeignKey(on_delete=None, to='CRM.UserProfile', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='referral_from',
            field=models.ForeignKey(blank=True, null=True, on_delete=None, to='CRM.CustomerInfo', verbose_name='转介绍'),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('customer', models.ForeignKey(on_delete=None, to='CRM.CustomerInfo')),
                ('user', models.ForeignKey(on_delete=None, to='CRM.UserProfile', verbose_name='跟进人')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='course',
            field=models.ForeignKey(on_delete=None, to='CRM.Course'),
        ),
        migrations.AddField(
            model_name='classlist',
            name='teachers',
